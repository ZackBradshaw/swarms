...
All new functions and classes in `swarms` should include docstrings following the Google Python docstring style. This is a prerequisite for any new functions and classes to be added to the library.
